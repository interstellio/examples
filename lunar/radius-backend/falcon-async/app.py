"""An example RADIUS backend for lunar, built with async Falcon (ASGI).
...
class VirtualsResource:
    ...
    async def on_get(self, req, resp, server_id):
...
class VirtualResource:
    ...
    async def on_get(self, req, resp, server_id, virtual_id):
        resp.text = json.dumps(TEST_VIRTUAL)
...
class AuthResource:
    ...
    async def on_post(self, req, resp, server_id, virtual_id):
        ...
        try:
            packet = json.loads(await req.bounded_stream.read() or b"{}")
        except ValueError:
            packet = {}
...
class CoaResource:
    ...
    async def on_post(self, req, resp, server_id, virtual_id):
        try:
            request_packet = json.loads(await req.bounded_stream.read()
                                        or b"{}")
        except ValueError:
            request_packet = {}
...
class LogResource:
    ...
    async def on_post(self, req, resp, server_id):
...
def create_app():
    """Build and return the Falcon ASGI application."""
...
# ASGI entry point (for uvicorn: ``uvicorn app:application``).
